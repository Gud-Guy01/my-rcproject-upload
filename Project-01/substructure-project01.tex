...
%     \extramarks{\thesection\quad #1}{\thesection\quad #1}%
% }
% \renewcommand{\subsectionmark}[1]{} % keep this empty so subsection doesn't override

\renewcommand{\sectionmark}[1]{%
    \markboth{\thesection\quad #1}{\thesection\quad #1}%
}
