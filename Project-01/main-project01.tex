...
\bibitem{EN 1990(5)}
EN 1990, \textit{Basis of Structural Design}

\bibitem{IStructE Manual(6)}
IStructE Manual, \textit{Manual for the Design of Concrete Building Structures to Eurocode 2}

\bibitem{Reynolds & Steedman(7)}
Reynolds \& Steedman, \textit{Reinforced Concrete Designer's Handbook, 10th Ed.}
\end{thebibliography}
