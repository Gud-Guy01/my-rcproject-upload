\subsection{Load}
For imposed laods on floor according to Table $6.1 - 6.4$ in EN 1991-1-1:2002 \cite{EN1991-1-1-2002(3)}:
...
\caption{Imposed Loads On Second Floor}
\end{longtable}

\section{Very Long Table Section}
% Manually set the mark before the longtable
\markright{\thesection\ Very Long Table Section}

\begin{longtable}{|c|c|}
\caption{This is a very long table that spans multiple pages} \label{tab:long}\\
\hline
...
% Your data here - repeat \markright if table is extremely long
Row 1 & Data \\
Row 2 & Data \\
% ... many rows ...
Row 100 & Data \\
...
% After table ends, section marks will resume automatically
